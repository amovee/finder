...
export class ChildrenStatus implements Status {
  ...
  public updateValidity(): void {
    if (this.alreadyChildren) {
      if (this.pregnant != null) {
        if (this.numberOfChildren != null) {
          if (this.birthDates.length >= this.numberOfChildren) {
            this.isValid = true;
    ...
    } else if (this.alreadyChildren == false) {
      this.isValid = !!this.pregnant;
    } else {
      this.isValid = false;
    }
  }
  ...
  public getResultFilter(result: any): boolean {
    // console.log(result.min_age, result.max_age,this.alreadyChildren);

    if (result.min_age == null && result.max_age == null || this.alreadyChildren && this.birthDates == null) {
      return true;
    }
    ...
    for (let i = 0; i < this.birthDates.length; i++) {
      const year: number = new Date().getFullYear() - new Date(this.birthDates[i]).getFullYear();
      const month: number = new Date().getMonth() - new Date(this.birthDates[i]).getMonth();
      // const day: number = new Date().getDate() - new Date(this.birthDates[i]).getDate();
      const minCondition = result.min_age == null || result.min_age < year + month / 12;
      const maxCondition = result.max_age == null || result.max_age > year + month / 12;
...
export class LifeSituationStatus implements Status {
  ...
  public toJson(): any {
    return Object.assign({},
      this.lifeSituationBasic === null ? null : { lSB: this.lifeSituationBasic },
      this.lifeSituationDivorce === null ? null : { lSD: this.lifeSituationDivorce },
  ...
  public getResultFilter(result: any): boolean {
    return (result.has_relationship == null || result.has_relationship.length == 0)
      ? true
  ...
  get relationshipType(): number | null {
    switch (this.lifeSituationBasic) {
      case 0: return 1;
      case 1: switch (this.lifeSituationDivorce) {
        case 0: return 2;
        case 1: return 3;
        case 2: return 4;
        default: return null;
...
export class HousingSituationStatus implements Status {
  ...
  public toJson(): any {
    return Object.assign({},
      ...
      this.housingSituationType === null ? null : { hST: this.housingSituationType },
  ...
  public getResultFilter(result: any): boolean {
    ...
    if (result.region != null) {
      inRegionFilter = states[+result.region].postalCodes.includes(
        this.place
      );
    }
...
export class WorkingStatus implements Status {
  ...
  get jobRelatedSituationType(): number | null {
    switch (this.situation) {
      case 0: switch (this.jobType) {
        case 0: return 1;
        case 1: switch (this.partTimeType) {
          case 0: return 2;
          case 1: return 3;
          default: return null;
        }
      ...
      case 1: switch (this.education) {
        case 0: return 6;
        case 1: return 7;
        case 2: return 8;
        default: return null;
      }
      case 2: switch (this.socialBenefitType) {
        case 0: return 9;
        case 1: return 10;
        case 2: return 11;
        case 3: return 12;
...
export class IncomeStatus implements Status {
  ...
  public toJson(): any {
    return Object.assign({},
      ...
      this.disabilityPensionExists === null ? null : { dPE: this.disabilityPensionExists },
      ...
      this.childBenefitExists === null ? null : { cBE: this.childBenefitExists },
      this.childBenefit === null ? null : { cB: this.childBenefit },
      this.rentalIncomeExists === null ? null : { rIE: this.rentalIncomeExists },
  ...
  public updateValidity() {
    if (
      ...
      (this.rentalIncomeExists == false || (this.rentalIncome != null && this.rentalIncome > 0)) &&
      (this.childBenefitExists == false || (this.childBenefit != null && this.childBenefit > 0)) &&
      (this.disabilityPensionExists == false ||
        (this.disabilityPension != null && this.disabilityPension > 0)) &&
      (this.entertainsExists == false || (this.entertains != null && this.entertains > 0))
    ) {
      this.isValid = true;
    } else {
      this.isValid = false;
  ...
  public getQueryFilters(): string[] {
    ...
    if (this.gross) {
      ...
      if (this.disabilityPensionExists == true && this.disabilityPension != null) {
...
export class FinderStatus {
  ...
  public static fromJson(json: any): FinderStatus {
    return new FinderStatus(
      ...
      json.ins != null ? InsuranceStatus.fromJson(json.ins) : new InsuranceStatus(),
